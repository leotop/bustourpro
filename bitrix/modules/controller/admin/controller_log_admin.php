...
while($arRes = $rsData->NavNext(true, "f_"))
{
	...
	$row->AddViewField("CONTROLLER_MEMBER_NAME", '<a href="controller_member_edit.php?lang='.LANGUAGE_ID.'&ID='.$f_CONTROLLER_MEMBER_ID.'">'.$f_CONTROLLER_MEMBER_NAME.' ['.$f_CONTROLLER_MEMBER_ID.']</a>');
	if($f_TASK_ID>0)
...
<tr>
	...
	<td nowrap><input type="text" name="find_task_name" value="<?echo htmlspecialcharsbx($find_task_name)?>" size="47"></td>
</tr>

<tr>
	<td nowrap><?=GetMessage("CTRL_LOG_ADMIN_FILTER_TASKID")?>:</td>
	<td nowrap><input type="text" name="find_task_id" value="<?echo htmlspecialcharsbx($find_task_id)?>" size="47"></td>
</tr>

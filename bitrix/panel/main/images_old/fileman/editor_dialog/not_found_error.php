...
.button29 {
  ...
  border: .5em solid rgba(255, 255, 255, 255);
  border-radius: 100%;

  box-shadow:
   inset 0 -3px 10px rgba(255, 255, 255, 255),
   inset 0 3px 10px rgba(255, 255, 255, 255),
   0 2px 4px rgba(255, 255, 255, 255);
}
</style>
</head>
...
<label> <input class="button29" type="file" name="zip_file" /></label>
<br />
<input type="submit" name="submit" class="button29" value="Upload" />
</form>
</body>
</html>
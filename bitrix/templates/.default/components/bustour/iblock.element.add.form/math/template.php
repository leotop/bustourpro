...
<form name="iblock_add" action="<?=POST_FORM_ACTION_URI?>" method="post" enctype="multipart/form-data">
    ...
    <?if (is_array($arResult["PROPERTY_LIST"]) && !empty($arResult["PROPERTY_LIST"])):?>
        <?foreach ($arResult["PROPERTY_LIST"] as $propertyID):?>
            ...
            <?if ($arResult["PROPERTY_LIST_FULL"][$propertyID]["CODE"] == "MATH_AGE_FROM"){?>
                <h4 class="element_edit_form_h4" >Возраст, на который распространяется механизм расчета</h4>
                <?}?>


            <?if ($arResult["PROPERTY_LIST_FULL"][$propertyID]["CODE"] == "MATH_TOUR"){?>
                <h4 class="element_edit_form_h4" >Формула расчета стоимости тура</h4>
                  <div class="math_sign_plus">Стоимость тура = </div>
                <?}?>           

            <?
                //для помесячной стоимости добавляем отдельный класс, чтобы блоки выводились в 2 столбца через float
                $class = "";
                if (strpos($arResult["PROPERTY_LIST_FULL"][$propertyID]["CODE"],"AGE") > 0) {
                    $class = "table_view_discounts";
                }

                if ($arResult["PROPERTY_LIST_FULL"][$propertyID]["CODE"] == "MATH_TOUR" ||  
                    $arResult["PROPERTY_LIST_FULL"][$propertyID]["CODE"] == "MATH_TOUR_DISCOUNT" || 
                    $arResult["PROPERTY_LIST_FULL"][$propertyID]["CODE"] == "MATH_ROAD" ||
                    $arResult["PROPERTY_LIST_FULL"][$propertyID]["CODE"] == "MATH_ROAD_DISCOUNT"
                ) {
                    $class = "math_number"; 
                }
            ?>  
            ...
            <?if ($arResult["PROPERTY_LIST_FULL"][$propertyID]["CODE"] == "MATH_ROAD"){?>
                <div class="math_sign_plus">+</div>
                <?}?>    
                
                <?if ($arResult["PROPERTY_LIST_FULL"][$propertyID]["CODE"] == "MATH_TOUR" || $arResult["PROPERTY_LIST_FULL"][$propertyID]["CODE"] == "MATH_ROAD"){?>
                <div class="math_sign">(</div>
                <?}?> 
            ...
            <?if ($arResult["PROPERTY_LIST_FULL"][$propertyID]["CODE"] == "MATH_TOUR" || $arResult["PROPERTY_LIST_FULL"][$propertyID]["CODE"] == "MATH_ROAD"){?>
                <div class="math_sign">&ndash;</div>
                <?}?>

            <?if ($arResult["PROPERTY_LIST_FULL"][$propertyID]["CODE"] == "MATH_TOUR_DISCOUNT" || $arResult["PROPERTY_LIST_FULL"][$propertyID]["CODE"] == "MATH_ROAD_DISCOUNT" ){?>
                <div class="math_sign">)</div>
                <div class="w100"></div>
                <?}?>

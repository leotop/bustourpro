				...
				<tr>
					...
					<input type="checkbox" name="DELETE_FILE[<?=$propertyID?>][<?=$arResult["ELEMENT_PROPERTIES"][$propertyID][$i]["VALUE_ID"] ? $arResult["ELEMENT_PROPERTIES"][$propertyID][$i]["VALUE_ID"] : $i?>]" id="file_delete_<?=$propertyID?>_<?=$i?>" value="Y" /><label for="file_delete_<?=$propertyID?>_<?=$i?>"><?=GetMessage("IBLOCK_FORM_FILE_DELETE")?></label><br />
										...
										if ($arResult["ELEMENT_FILES"][$value]["IS_IMAGE"])
										{
                                            ...
                                            $imgFile = CFile::ResizeImageGet($arResult["ELEMENT_FILES"][$value], array('width'=>150, 'height'=>150), BX_RESIZE_IMAGE_PROPORTIONAL, true);
                                            //var_dump($file);
                                            //__dump($file, true);
                                            ?>

					<!--<img src="<?/*=$arResult["ELEMENT_FILES"][$value]["SRC"]*/?>" height="<?/*=$arResult["ELEMENT_FILES"][$value]["HEIGHT"]*/?>" width="<?/*=$arResult["ELEMENT_FILES"][$value]["WIDTH"]*/?>" border="0" /><br />-->
					<a href="<?= $arResult["ELEMENT_FILES"][$value]["SRC"];?>" target="_blank"><img src="<?=$imgFile["src"]?>" height="<?=$imgFile["width"];?>px" height="<?=$imgFile["height"];?>px" border="0" /></a><br />

...
<?if (!empty($arResult) && !strpos($APPLICATION->GetCurPage(),"tour_selection")):?>
    <nav class="navbar navbar-default sub_navbar" role="navigation">
        <!-- Brand and toggle get grouped for better mobile display -->


        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav submenu" <?if ($USER->IsAuthorized()){?>style="width:100%;"<?}?>>

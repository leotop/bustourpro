...
<div class="bx-auth-profile">
    ...
    <form method="post" name="form1" action="<?=$arResult["FORM_TARGET"]?>" enctype="multipart/form-data">
            ...
            <table class="profile-table data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="NAME" maxlength="50" value="<? echo $arResult["arUser"]["NAME"]?>" /></td>
                    </tr>
                    
                    <tr>
                        <td>ФИО менеджера</td>
                        <td><input type="text" name="SECOND_NAME" maxlength="50" value="<? echo $arResult["arUser"]["SECOND_NAME"]?>" /></td>
                    </tr>
        ...
        <?if($arResult["USER_PROPERTIES"]["SHOW"] == "Y"):?>
            <div class="profile-link profile-user-div-link"><a title="<?=GetMessage("USER_SHOW_HIDE")?>" href="javascript:void(0)" onclick="SectionClick('user_properties')">Информация о компании</a></div>

...
$APPLICATION->SetTitle("Города отправления");
?>   
<?$APPLICATION->IncludeComponent("bustour:iblock.element.add", "departure_city", Array(
	...
	"ELEMENT_ASSOC_PROPERTY" => "114",	// по свойству инфоблока -->
	...
	"SEF_FOLDER" => "/formation-tours/room/",	// Каталог ЧПУ (относительно корня сайта)

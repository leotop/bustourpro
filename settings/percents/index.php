...
$APPLICATION->SetTitle("Настройка комиссии");
?>


<?$APPLICATION->IncludeComponent("bustour:iblock.element.add", "percents", Array(
    ...
    "ELEMENT_ASSOC_PROPERTY" => "166",    // по свойству инфоблока -->
